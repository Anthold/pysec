...
def main():
    parser = optparse.OptionParser('usage%prog -H <target host> -u <user> -d <keyfile directory>')
    parser.add_option('-H', dest='tgtHost', type='string', help='specify target host')
    parser.add_option('-u', dest='user', type='string', help='specify user name')
    parser.add_option('-d', dest='passdir', type='string', help='specify the keyfile directory')
